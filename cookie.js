...
purecookieLink='<a href="cookie.html" target="_blank">Saiba Mais</a>',
purecookieButton="Ok,Aceito";
...
function pureFadeOut(e){
    ...
    o.style.opacity=1,
    function e(){
        (o.style.opacity-=.02)<0?
        o.style.display="none":requestAnimationFrame(e)
    }()
}
